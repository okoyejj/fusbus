export default async function AdminLoginPage({ searchParams }: { searchParams: Promise<{ error?: string; notice?: string }> }) {
  ...
  const errorMessage =
    error === "blocked"
      ...
      : error === "limited"
        ...
        : error === "locked"
          ? "This admin account is temporarily locked after repeated failed attempts. Try again in 15 minutes."
          : error === "reset-invalid"
